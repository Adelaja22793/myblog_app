...
export default function Login() {
  ...
  const validateForm = () => { 
    ...
    // if (formData.userName == "")
    // {
    //   errors.userName = 'Plese Enter UserName';
    // }
    setErrors(errors); 
        ...
        <div className="relative bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-xl sm:px-10 w-9/12">
          <div className="mx-auto max-w-md">
            <div style={{display: "flex", alignItems: "center", marginBottom: 10}}>
              ...
              <p style={{fontFamily: "sans-serif", fontWeight: "bold"}}>Forgot Password</p>
            </div>
            {formSuccessMessage && (
            ...
            <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
              <form>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/form/login" className="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">Back to Login?</Link> 
